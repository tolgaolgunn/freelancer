...
import "./Add.scss"; // CSS dosyasını projeye eklemeyi unutmayın
  ...
  return (
    <div className="add-container">
      <form className="add-form" onSubmit={handleSubmit}>
        <h2 className="form-title">Create a New Gig</h2>
        ...
        <div className="form-group">
          ...
          <textarea ref={descriptionRef} id="description" placeholder="Description" required />
        </div>
        <div className="form-group">
          <label htmlFor="shortDesc">Short Description</label>
          <textarea ref={shortDescRef} id="shortDesc" placeholder="Short Description" required />
        </div>
        <div className="form-row">
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <select ref={categoryRef} id="category" required>
